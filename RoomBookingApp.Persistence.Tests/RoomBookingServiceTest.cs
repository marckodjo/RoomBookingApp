...
namespace RoomBookingApp.Persistence.Tests
{
    public class RoomBookingServiceTest
    {
        ...
        public void Should_Return_Available_Rooms()
        {
            ...
            context.Add(new RoomBooking { RoomId = 1, Date = date, Email="test@testo.com", FullName="Toto" });
            context.Add(new RoomBooking { RoomId = 2, Date = date.AddDays(-1), Email = "titi@testo.com", FullName = "Titi" });
        ...
        public void Should_Save_Room_Booking()
        {
            ...
            var roomBooking = new RoomBooking { RoomId = 1, Date = new DateTime(2021, 06, 09), Email = "tito@testo.com", FullName = "Toti" };
